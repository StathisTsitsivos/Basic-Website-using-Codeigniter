...
.vertical-center {
  ...
  <body>
    ...
    <div  style="text-align:center">
      ...
      <p>Fill in the details to login on our website! <br> Hello Admin!</p>
      <?php if (isset($_SESSION['success'])) { ?>
          <div class="alert-alert-success"> <?php echo $_SESSION['success']; ?></div>
      <?php
      } ?>
      <form action="<?php echo base_url('index.php/Auth_admin/login'); ?>"  method="POST"> 
      ...
      <?php if($this->session->flashdata('form_validation_error')) {
       ...
       ?>
        ...
        <div>
            <a href= "<?php echo base_url(); ?>index.php/auth/index"><div> <button type="submit">Customer</button> </a>
