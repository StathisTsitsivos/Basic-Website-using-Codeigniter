...
<html lang="en">
  ...
  <div style="text-align:center">
      ...
      <form action="<?php echo base_url('index.php/message/writemessage'); ?>" method="POST"> 

      <div style="text-align:center">
        <div class="col-lg-20 col-lg-offset-20">
        <div class="form-group">
            <label for="message" >Message:</label>
            <textarea  class="form-cotrol" name="message" id="message" type="text" rows= "20" cols="100"></textarea>
        </div> 
